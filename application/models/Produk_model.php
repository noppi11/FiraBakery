...
class Produk_model extends CI_Model {
    ...
    public function getProduk($limit, $start, $search = null, $kategori = null, $sort = null)
    {
        ...
        if ($sort == 'asc') {
            ...
            $this->db->order_by('produk.nama_produk', 'DESC');
...
public function getProdukFiltered($search = null, $id_kategori = null)
{
    ...
    public function getRelated($id_kategori, $id_produk, $limit = 4)
{
    $this->db->where('id_kategori', $id_kategori);
    $this->db->where('id_produk !=', $id_produk); // jangan tampilkan produk yg sama
    $this->db->limit($limit);
