...
<html
  ...
  data-assets-path="<?= base_url('assets/template/') ?>/assets/"
...
>
  <head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/template/') ?>/assets/vendor/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('assets/template/') ?>/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= base_url('assets/template/') ?>/assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/template/') ?>/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Fira Bakery</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="<?=base_url('auth/registrasi_proses')?>" method="POST">
                <div class="mb-3">
